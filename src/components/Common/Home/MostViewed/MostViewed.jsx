...
const MostViewed = () => {
    ...
    const { isPending, isError, error, data } = useQuery({
        ...
        queryFn: async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_PATH}/products/get-all?sortBy=-view`)
    ...
    return (
        <div className='font-main'>
            <div className='flex gap-2 items-center'>
                <p className='text-[20px] font-[600] text-secondary-text-color'>Most Viewed</p>
