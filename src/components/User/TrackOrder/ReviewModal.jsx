        ...
        <div className='fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center px-2'>
            <div className='bg-white py-4 rounded-sm flex flex-col gap-3 w-[472px]'>
                <div className='flex justify-between px-4 items-center'>
                    ...
                    <CiCircleRemove
                        className='w-6 h-6 cursor-pointer text-gray-400 hover:text-green-500 transition duration-300 ease-in-out'
                        onClick={() => {
                            setShowReviewModal(false)
                        }}
                    />
                ...
                <div className='flex justify-start gap-2 px-4 flex-col text-[14px] relative'>
                    ...
                    <select
                        ...
                        className='border-2 border-gray-100 rounded-sm px-2 py-2 appearance-none outline-none cursor-pointer text-green-600'>
                        {
                            [5, 4, 3, 2, 1].map((i) => (
                ...
                >
                    <button
                        ...
                        className='bg-[#4E97FD] text-primary-text-color px-4 py-1 rounded-sm text-[10px] absolute right-2 bottom-2'
                    >
                        Upload
                    </button>
