        ...
        <div className='flex justify-start items-start flex-col mb-1'>
            {type !== 'password' ? (
                ...
                <div className='relative w-[100%]'>
                    ...
                    />
                    {showPassword ? (
                        <FiEyeOff className='text-gray-400 text-xl cursor-pointer absolute top-10 right-3' onClick={toggleShowPassword} />
                    ) : (
                        <FiEye className='text-gray-400 text-xl cursor-pointer absolute top-10 right-3' onClick={toggleShowPassword} />
                    )}
                </div>
            )}
        </div>
