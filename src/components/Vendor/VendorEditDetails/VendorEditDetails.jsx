...
import styles from '../../../lib/css/VendorEditDetails.module.css'
  ...
  return (
    <div className='p-2 lg:px-6 lg:py-6 rounded-sm my-4' style={{
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-x-4 mt-4 font-main'>
        ...
        <TextField label='Phone Number' placeholder={user?.vendor_info?.business_phone_no ? user?.vendor_info?.business_phone_no : 'Please provide your number'} value={newPhone} onChange={setNewPhone} />
        <TextField label='Region' placeholder={user?.vendor_info?.region ? user?.vendor_info?.region : 'Please provide your country'} value={newCountry} onChange={setNewCountry} />
        {/* <div>
