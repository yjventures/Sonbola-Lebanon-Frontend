...
const VendorAllReviews = () => {
    ...
    return (
        <div className='font-main lg:-ms-10'>
            ...
            {/* name and image */}
            <div className='flex items-center gap-2 mt-6 ms-2'>
                <img src={newProduct?.images[0]} alt="image" className='w-10 h-10 rounded-sm' />
                <p>
                    {
                        newProduct?.name?.en
                    }
                                    ...
                                    <tr key={productIndex}>
                                        ...
                                        <td>
                                            <MdOutlineRemoveRedEye
                                                ...
                                                className='ms-12 cursor-pointer w-5 h-5 text-gray-600 hover:text-green-600 transition'
                                            />
                                        </td>
                                    </tr>
                                ))}
