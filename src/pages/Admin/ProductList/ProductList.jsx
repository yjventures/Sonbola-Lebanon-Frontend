...
const ProductList = () => {
  ...
  return (
    <div className='font-main'>
      <VendorHeader text='Product List' />
        ...
        <div className='flex justify-between items-start mt-5 gap-2 flex-col lg:flex-row lg:items-center'>
          <div className='relative text-[12px] w-full'>
            <input type="text"
              ...
              className='bg-gray-50 rounded-md px-8 py-2 w-full outline-none text-gray-500' />
          ...
          {/* <button
            ...
            className='hover:bg-green-600 transition text-[12px] border-2 border-[#E5E5E5] bg-[#1A985B] text-primary-text-color rounded-md py-2 w-32 lg:w-36 flex justify-center items-center gap-1 mt-2 lg:mt-0'>
            <GoPlus />
            Bulk Upload
          </button>
          <button
                  ...
                  data
                    ...
                    ?.map((product, productIndex) => (
                      <tr
                        ...
                        <ProductTableCell label={product?.brand} type='category' hiddenOnLG />
                        ...
                        >
                          ...
                          >
                            ...
                            <span
                              aria-hidden="true"
                              className={classNames(
                                product.is_published == true ? 'bg-green-600' : 'bg-gray-200',
